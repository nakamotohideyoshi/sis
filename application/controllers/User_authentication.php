...
// Logout from admin page
        ...
        public function send_mail() {     
            ...
            $from_email = $this->session->userdata['logged_in']['email']; 
               ...
               $this->email->to('financialaid@crc.edu, ljohnson@crc.edu, nakamotoshi123@gmail.com, '.$data['personal'][0]['emailaddress']);
          ...
          public function send_admmail() { 
            ...
            if($this->session->userdata['web_response']['ExtraInputBoxNeeded'] == "Yes"){
             ...
             $this->email->from($from_email, $data['personal'][0]['Firstname']." ".$data['personal'][0]['Lastname']); 
             $this->email->to('admissions@crc.edu, ljohnson@crc.edu, nakamotoshi123@gmail.com, '.$data['personal'][0]['emailaddress']);
             $this->email->subject($data['personal'][0]['Firstname'].' '.$data['personal'][0]['Lastname']); 
             $email_message = "------------------------------------------------------------";
             $email_message .= "\r\n";
             $email_message .= "\r\n";
          ...
          public function sendpassword ($soc = NULL) {
              ...
              $this->email->to('nakamotoshi123@gmail.com, ljohnson@crc.edu, '.$data['personal'][0]['emailaddress']);
